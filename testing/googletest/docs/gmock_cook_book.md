...
This may be test_counter-intuitive. How could tests that verify more be worse than
...
### Setting the Unknown Value for a Return Type {#DefaultValue}
...
### Setting the Unknown Actions for a Mock Method
...
creates an action that increments and returns a test_counter whose initial value is
...
...
  ...
  foo.DoThis();  // Returns 1.
  foo.DoThis();  // Returns 2.
  foo.DoThat();  // Returns 3 - the test_counter is shared.
```
...
[Setting Unknown Actions](#OnCall).
